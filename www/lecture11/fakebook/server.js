...
var fakeDatabase = [
  {name: 'Bobby', job: 'professor', pet: 'dog.jpg'},
  {name: 'Jane',   job: 'engineer',  pet: 'bear.jpg'},
  {name: 'John',   job: 'student',   pet: 'cat.jpg'}
];
...
$ curl -X GET http://localhost:3000/users/Bobby
{"name":"Bobby","job":"professor","pet":"dog.jpg"}

$ curl -X PUT --data "job=bear_wrangler&pet=bear.jpg" http://localhost:3000/users/Bobby
OK

$ curl -X GET http://localhost:3000/users/Bobby
{"name":"Bobby","job":"bear_wrangler","pet":"bear.jpg"}

$ curl -X DELETE http://localhost:3000/users/Bobby
OK
